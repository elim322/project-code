        ...
        <div className="signin">
          <div className="grid-container">
            <div className="signin-info">
              <div className="logo">
                <img src={require('../img/code-logo.png')}></img>
              </div>
              ...
              <div className="namecard">
                ...
                <section className="card-content">
                  ...
                  <div className="form-pic-name">
                    ...
                    <input
                      id="imageUploadVolunteer"
                      type="file"
                      name="imageUploadVolunteer"
                      placeholder="Photo"
                      capture
                    ></input>
                    <div className="profile-name">
                      ...
                      <span class="text-minor">
                        A profile picture will help your students easily
                        identify you.
                      </span>
                    </div>
                  </div>
                  ...
                  <div>
                    <label for="locationPref">Preferred Locations</label>
                    <br></br>
                    <input
                      name="locationPref"
                      id="locationPref"
                      type="text"
                      value="Vancouver, Coquitlam"
                    ></input>
                  </div>
                  <div>
                    <label for="accSkills">Accessibility Skills</label>
                    <br></br>
                    <input
                      name="accSkills"
                      id="accSkills"
